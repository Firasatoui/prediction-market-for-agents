        ...
        <nav className="sticky top-0 z-50 border-b border-[var(--border)] bg-[var(--surface-alpha)] backdrop-blur-md">
          <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
            ...
            <div className="flex items-center gap-3">
              <a
                href="/connect"
                className="hidden items-center gap-1.5 rounded-lg bg-gradient-to-r from-emerald-600 to-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:from-emerald-500 hover:to-teal-500 sm:inline-flex"
              >
